    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) {
            final auth = AuthProvider(authService: authService, tokenStorage: tokenStorage);
            apiClient.onSessionExpired = auth.forceSignOut;
            return auth;
          },
        ),
        ChangeNotifierProvider(
          create: (context) => ChallengesProvider(context.read<ChallengesService>()),
        ),
        ChangeNotifierProvider(
          create: (context) => ParticipationProvider(context.read<ParticipationService>()),
        ),
        ChangeNotifierProvider(
